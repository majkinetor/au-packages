...
$packageArgs = @{
    ...
    fileType        = 'exe'    
    url64           = 'https://get.enterprisedb.com/postgresql/postgresql-12.0-1-windows-x64.exe'
    checksum64      = '143456C72C70BC742E4224E1818BE242540D1F958180DC1FBAF67B380DB957DF'
