...
$packageArgs = @{
    ...
    fileType        = 'exe'    
    url64           = 'https://get.enterprisedb.com/postgresql/postgresql-11.5-2-windows-x64.exe'
    checksum64      = 'EBEA308BEB7FDB05BC5E106C527E58E4E807E5E8B2B1C4AE99D5469D6F44F96A'
