...
$packageArgs = @{
    ...
    fileType        = 'exe'
    url64           = 'https://get.enterprisedb.com/postgresql/postgresql-15.0-2-windows-x64.exe'
    checksum64      = 'ED3DEF35C40474F534C6F77A6294D99594B28515C5F09845475320E1DBEADA20'
