...
$packageArgs = @{
    ...
    fileType        = 'exe'    
    url64           = 'https://get.enterprisedb.com/postgresql/postgresql-12.1-1-windows-x64.exe'
    checksum64      = '5BF95FB2CB404ED9042DE77031CBF9E49440A09C1B35766BB20623D9588BD8BA'
