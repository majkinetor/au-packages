...
$(
    ...
    $AppVeyor_StatusId = '9ipva7kgjigug2rn'
)

[![](https://ci.appveyor.com/api/projects/status/${AppVeyor_StatusId}?svg=true)](https://ci.appveyor.com/project/$Github_UserRepo/build/$Env:APPVEYOR_BUILD_NUMBER)
...
_This file is automatically generated by the [update_all.ps1](https://github.com/$Github_UserRepo/blob/master/update_all.ps1) script using the [AU module](https://github.com/majkinetor/au) ( [view source](https://github.com/$Github_UserRepo/blob/master/gist.md.ps1) )._

|||
|---               | --- |
**Time (UTC)**     | $($Info.startTime.ToUniversalTime().ToString('yyyy-MM-dd HH:mm'))
**Git repository** | https://github.com/$Github_UserRepo
