...
[![$package_no](https://img.shields.io/badge/AU%20packages-$($pno)-red.svg)](#ok)
[![$au_version](https://img.shields.io/badge/AU-$($au)-blue.svg)](https://www.powershellgallery.com/packages/AU)
