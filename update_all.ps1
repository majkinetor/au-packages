...
$Options = [ordered]@{
    ...
    Report = @{
        ...
        Params= @{                                          #Report parameters:
            ...
            UserMessage = "[History](#update-history) | [Force Test]([https://gist.github.com/majkinetor/63cbcd31fb64837dd5e3d994cb4e4f65]) | **USING AU NEXT VERSION**"       #  Markdown, Text: Custom user message to show
