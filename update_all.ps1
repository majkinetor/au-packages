...
$Options = [ordered]@{
    ...
    Report = @{
        ...
        Params= @{                                          #Report parameters:
            ...
            UserMessage = "[History](#update-history) | [Force Test](https://gist.github.com/$Env:gist_id_test) | **TESTING AU STREAMS VERSION**"       #  Markdown, Text: Custom user message to show
