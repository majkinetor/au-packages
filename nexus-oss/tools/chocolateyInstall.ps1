...
$url         = 'https://sonatype-download.global.ssl.fastly.net/nexus/oss/nexus-2.14.8-01-bundle.zip'
$checksum    = '3f3cb61f908c461084f84bedeae1ec05db918905289dcf7fd3f662590306667d'
$installDir  = 'c:\nexus'
