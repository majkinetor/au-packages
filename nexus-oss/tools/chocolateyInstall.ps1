...
$url         = 'https://sonatype-download.global.ssl.fastly.net/nexus/oss/nexus-2.14.2-01-bundle.zip'
$checksum    = '43db56f306cf207e221947b3de9c5d3bf116d1eb121807fc900c9b9b61c83efd'
$installDir  = 'c:\nexus'
