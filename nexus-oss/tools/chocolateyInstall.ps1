...
$url         = 'https://sonatype-download.global.ssl.fastly.net/nexus/oss/nexus-2.14.4-03-bundle.zip'
$checksum    = '3001d9ed3252a684794f053340c8ab9fc0ab5cc5fb4b4cf533dc46ab7a980412'
$installDir  = 'c:\nexus'
