...
$url         = 'https://sonatype-download.global.ssl.fastly.net/nexus/oss/nexus-2.14.1-01-bundle.zip'
$checksum    = '977fab49b0ecf86f2d021909a6f1df9a05595879b8e52b717fa9da0b04bb79ff'
$installDir  = 'c:\nexus'
