...
$url         = 'https://sonatype-download.global.ssl.fastly.net/nexus/oss/nexus-2.14.7-01-bundle.zip'
$checksum    = 'b7632a2fe4aa5068ac7ed41b2771772897841a7c7d758a2f03d214ae4e07d4ea'
$installDir  = 'c:\nexus'
