...
$url         = 'https://sonatype-download.global.ssl.fastly.net/repository/repositoryManager/oss/nexus-2.14.9-01-bundle.zip'
$checksum    = '8f3c8963da80a68a953c1a50cdd6c06574b4331767c56d866139c4b8151ab001'
$installDir  = 'c:\nexus'
